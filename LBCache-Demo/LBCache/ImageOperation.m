...
- (void) main
{
    ...
    [NSURLConnection synchronousDownloadImageDataFromURLString: self.urlString completionBlock:^(UIImage *image, NSData *imageData, NSHTTPURLResponse *response, NSError *error) {
